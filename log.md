# Kaggle 50 Startups 專案工作日誌 (Project Work Log & Changelog)

本工作日誌記錄了本專案的開發歷程、功能重構、實驗更動與版本發布紀錄。

---

## 📅 2026-06-15 工作日誌 — 專案整理與 Git 發布

### 任務目標
1. 整理專案結構與文件，生成適合 GitHub 儲存庫的項目文檔。
2. 創建全方位的 `README.md`，提供清晰的目錄指引、實驗結果與配置運行指南。
3. 建立並同步 Git 遠端儲存庫，上傳代碼、圖表、資料與網頁到 GitHub。

### 完成事項與異動清單
*   **[NEW]** [README.md](file:///d:/20260611-HW6-Bussiness-prediction-lesson-main/20260611-HW6-Bussiness-prediction-lesson-main/README.md)
    - 撰寫完整的專案簡介、目錄樹狀圖、核心成果摘要（多模型比較、特徵選取實驗、迴歸統計診斷）、網頁端互動儀表板簡介與完整安裝運行指南。
*   **[MODIFY]** [log.md](file:///d:/20260611-HW6-Bussiness-prediction-lesson-main/20260611-HW6-Bussiness-prediction-lesson-main/log.md)
    - 將工作日誌重構為多日誌合併格式，新增 2026-06-15 開發與上傳紀錄。
*   **[Git & GitHub Setup]**
    - 配置本地 Git 用戶身分資訊（`user.name` 與 `user.email`）。
    - 綁定遠端 GitHub 儲存庫 `https://github.com/mrhuang55-creator/20260611-HW6-Bussiness-prediction-lesson.git`。
    - 將所有源碼、預處理數據、多模型權重、精美圖表（包含英文版與繁體中文版）以及互動式網頁進行追蹤提交，並推送至 GitHub `main` 分支。

---

## 📅 2026-06-12 工作日誌 — 迴歸診斷與特徵選取實驗
